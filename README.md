...
You'll be able to provide the necessary parameters through the UI and then generate your awesome list such as the openai key, model type, keyword and description.
